...
- `fixer` — `openai-codex/gpt-5.6-sol`, thinking medium, fallback `anthropic/claude-fable-5`; `defaultContext: fresh`; bounded remediation from an explicit fix list; `maxSubagentDepth: 0`

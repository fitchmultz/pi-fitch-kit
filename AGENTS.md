...
- Use configured agent defaults first: worker/researcher/scout/context-builder are medium-effort, reviewer/fixer are high-effort, ui-designer is xhigh, and oracle is xhigh forked-context by default.
